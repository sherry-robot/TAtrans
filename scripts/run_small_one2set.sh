...
if [ "${tittle}" = true ] ; then
    main_args="Tittle-Seed${seed}_Dropout${dropout}_LR${learning_rate}_BS${batch_size}_MaxNum${max_kp_num}_LossScalePre${loss_scale_pre}_LossScaleAb${loss_scale_ab}"
else
    main_args="Seed${seed}_Dropout${dropout}_LR${learning_rate}_BS${batch_size}_MaxNum${max_kp_num}_LossScalePre${loss_scale_pre}_LossScaleAb${loss_scale_ab}"
