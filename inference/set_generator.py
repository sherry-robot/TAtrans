...
#n_best_result = generator.inference(src, src_lens, src_oov, src_mask, oov_lists, word2idx)
    def inference(self, src, src_lens, src_oov, src_mask, oov_lists, word2idx,tlt, tlt_lens, tlt_mask):
        """
        ...
        title_embed, src_embed = self.model.encoder(src, src_lens, src_mask, tlt, tlt_lens, tlt_mask)

        encoder_output =  self.model.title_attention_merge(src_embed, title_embed, src_mask)
        state = self.model.decoder.init_state(encoder_output, src_mask)
